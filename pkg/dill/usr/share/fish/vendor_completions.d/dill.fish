...
#
#  Script Purpose:
#    Fish shell completion script for the dill utility.
# -------------------------------------------------
...
complete -c dill -f -n '__fish_is_first_arg' -a 'update install remove search query help -Syu -S -R -Q -h --help'
...
complete -c dill -f -n '__fish_seen_subcommand_from search query -Q' -a '(__dill_packages)'
